...
public class CloneableBean implements Serializable, Cloneable {
    ...
    public CloneableBean(Object obj,Set<String> ignoreProperties) {
        ...
        if(ignoreProperties == null) {
        	_ignoreProperties = Collections.emptySet();
        } else {
	...
	private Object doClone(Object value) throws Exception {
        if (value != null) {
            ...
            if (value instanceof Collection) {
                value = cloneCollection((Collection<Object>)value);
            }
            else
            if (value instanceof Map) {
                value = cloneMap((Map<Object, Object>)value);
            }
            else
	...
	private Object cloneCollection(Collection<Object> collection) throws Exception {
		Class<?> cClass = collection.getClass();
		@SuppressWarnings("unchecked")
        Collection<Object> newColl = (Collection<Object>) cClass.newInstance();
    ...
    private Object cloneMap(Map<Object, Object> map) throws Exception {
