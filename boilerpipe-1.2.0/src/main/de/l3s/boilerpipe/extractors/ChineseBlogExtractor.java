...
import de.l3s.boilerpipe.filters.chinese.*;
 ...
 */
public final class ChineseBlogExtractor extends ExtractorBase {
    public static final ChineseBlogExtractor INSTANCE = new ChineseBlogExtractor();
    
    /**
     * Returns the singleton instance for {@link ChineseBlogExtractor}.
     */
    public static ChineseBlogExtractor getInstance() {
        return INSTANCE;
    }
    ...
    public boolean process(TextDocument doc)
        ...
        ChineseTerminatingBlocksFinder.INSTANCE.process(doc)
                | ChineseContentBlocksFinder.INSTANCE.process(doc)
